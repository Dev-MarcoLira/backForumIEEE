...
async function handleCreateCategoria(req, res) {
    try {
        ...
        if (e.message.includes("obrigat�rio") || e.message.includes("j� existe")) {
...
async function handleReadCategoriaById(req, res) {
    try {
        ...
        if (e.message.includes("obrigat�rio") || e.message.includes("n�o encontrada")) {
...
async function handleUpdateCategoria(req, res) {
    try {
        ...
        if (e.message.includes("obrigat�rio") || e.message.includes("n�o encontrada") || e.message.includes("j� existe outra categoria com o nome")) {
            return res.status(400).json({ erro: e.message });
        }
...
async function handleDeleteCategoria(req, res) {
    try {
        ...
        if (e.message.includes("n�o pode ser deletada pois est� associada")) {
